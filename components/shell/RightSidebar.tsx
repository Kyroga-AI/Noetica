  ...
  return (
    <div className="space-y-1 p-2">
      {inScopeFiles.length > 0 && (
        <>
          <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pb-0.5">In scope · {inScopeFiles.length}</div>
          {inScopeFiles.map((f) => (
      ...
      {activity.length > 0 && (
        <>
          <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pt-2 pb-0.5">Activity · {activity.length}</div>
          {activity.map((a, i) => (
            <SlotRow key={`${a.id}-${i}`}>
      ...
      {changes.length > 0 && (
        <>
          <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pt-2 pb-0.5">Changes · {changes.length}</div>
          {changes.map((c) => (
            <div key={c.id}>
              <button
...
const MOCK_CONTENT: Record<AgentSlotId, React.ReactNode | null> = {
  context: (
    <div className="space-y-1 p-2">
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pb-0.5">In scope</div>
      ...
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pt-2 pb-0.5">Memory</div>
      <SlotRow>3 relevant memories active</SlotRow>
    </div>
  ),
  mail: (
    <div className="space-y-1 p-2">
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pb-0.5">Status</div>
      <SlotRow><span className="flex items-center gap-1.5"><StatusDot level="ok" />Monitoring · 2m ago</span></SlotRow>
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pt-2 pb-0.5">Flagged</div>
      <SlotRow accent="warn"><span className="flex items-center gap-1.5"><StatusDot level="warn" />2 threads need attention</span></SlotRow>
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pt-2 pb-0.5">Drafts queued</div>
  ...
  calendar: (
    <div className="space-y-1 p-2">
      ...
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pt-2 pb-0.5">Today</div>
  ...
  tasks: (
    <div className="space-y-1 p-2">
      ...
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pt-2 pb-0.5">Done today</div>
  ...
  graph: (
    <div className="p-2">
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pb-2">Concept graph · this session</div>
      <GraphMini />
      <div className="mt-2 text-[11px] font-semibold text-[var(--color-text-tertiary)] pb-1">Top concepts</div>
  ...
  lattice: (
    <div className="space-y-1 p-2">
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pb-0.5">Value generated</div>
      ...
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pt-2 pb-0.5">Session total</div>
  ...
  feed: (
    <div className="space-y-1 p-2">
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pb-0.5">Top signals</div>
      ...
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pt-2 pb-0.5">Bluesky · your network</div>
...
function RiskSlot({ riskReadout }: { riskReadout?: RiskAversionLiveReadout | null }) {
  ...
  return (
    <div className="space-y-1.5 p-2">
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pb-0.5">Dominant dimensions</div>
      ...
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pt-2 pb-0.5">Caution delta</div>
      ...
      {latestTurn.steeringModes.length > 0 && latestTurn.steeringModes[0] !== 'direct_answer' && (
        <>
          <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pt-2 pb-0.5">Observed steering</div>
          {latestTurn.steeringModes.map((mode) => (
            <SlotRow key={mode}>{mode.replace(/_/g, ' ')}</SlotRow>
          ))}
        </>
      )}
      <div className="text-[11px] font-semibold text-[var(--color-text-tertiary)] pt-2 pb-0.5">Turn</div>
  ...
  return (
    <div className="border-t border-[var(--color-border-tertiary)] bg-[var(--color-background-secondary)] p-3">
      <div className="mb-2 flex items-center justify-between">
        <span className="text-[11px] font-semibold text-[var(--color-text-tertiary)]">Configure agent</span>
