  ...
  return (
    <div className="rounded-xl border border-[var(--color-border-secondary)] bg-[var(--color-background-primary)] px-3 py-2.5">
      <div className="flex items-center gap-2">
        ...
        <span className="ml-auto shrink-0 rounded bg-[var(--color-background-secondary)] px-1.5 py-0.5 text-[11px] font-medium text-[var(--color-text-secondary)]">{fmtParams(m.paramsB)}</span>
      </div>
      <div className="mt-1 flex flex-wrap gap-1 text-[11px] text-[var(--color-text-tertiary)]">
        ...
        {err ? <div className="rounded-xl border border-[#fecaca] bg-[#fef2f2] px-4 py-2 text-xs text-[#dc2626]">{err} — run under dev:app</div>
          ...
          : (
            <>
              ...
              <div className="rounded-xl bg-[var(--color-background-secondary)] px-3 py-2 text-[11px] text-[var(--color-text-secondary)]">
