...
const INTENTS: Intent[] = [
  ...
  { id: 14, name: 'status_check', model: 'general', retrieval: 'status', slots: ['component'], tools: ['brain_status'], surface: 'operate', skill: 'governance-sentinel', cues: /\b(is it (running|working|up|on)|status|does it work|did it (work|boot|build)|health|still (broke|busted|working)|is your knowledge (current|up to date|loaded))\b/i },
